...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisbleAnymore() {
        let image0 = makeImage(url: URL(string: "https://url-0.com")!)
        let image1 = makeImage(url: URL(string: "https://url-1.com")!)
        let (sut, loader) = makeSUT()
    ...
    func test_feedImageView_rendersImageLoadedFromURL() {
        ...
        XCTAssertEqual(view1?.renderedImage, .none, "Expected no image state change for second view once first image while loading completes successfully")
    ...
    func test_loadFeedCompletion_dispatchesFromBackgroundToMainThread() {
        ...
        let expectation = self.expectation(description: "Wait for background queue")
